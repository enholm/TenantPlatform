    ...
    ITenantAuthorizationService authorization)
{
    ...
    public async Task<List<Department>> GetAllAsync(CancellationToken cancellationToken = default)
    {
        ...
        return await db.Departments.AsNoTracking().Where(x => x.AccountId == accountId)
